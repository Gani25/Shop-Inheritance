...
// inheritance product can be reuse to other classes
public abstract class Product implements Comparable<Product> {
    ...
    public int compareTo(Product specifiedObject) {
        ...
        String sOClassName = specifiedObject.getClass().getSimpleName();
        if (!(className.equals(sOClassName))) {
            return className.compareTo(sOClassName);
        }
